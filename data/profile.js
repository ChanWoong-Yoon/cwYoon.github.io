...
const PROFILE = {
  ...
  intro: [
    ...
    "This is why I study how to turn neurons on and off without genetic modification. Conventionally, optogenetics established precise spatiotemporal control of neural activity, but only by delivering and expressing foreign genes in the target cells. Powerful as it is, that requirement brings a long delay between surgery and experiment, uncertainty in expression, and — most importantly — a fixed direction of control: a channel designed to excite cannot also be used to inhibit.",
  ...
  links: [
    { label: "Google Scholar", url: "https://scholar.google.com/citations?user=xF9R1D8AAAAJ" },
