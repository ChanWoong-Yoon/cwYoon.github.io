...
const RESEARCH = [
  {
    ...
    lede: "Optogenetics needs a gene delivered, expressed, and waited on — and each construct only ever pushes one way.",
    body: [
  ...
  },
  {
    ...
    lede: "Nanoparticle neuromodulation does not work in an intact brain unless the particles, the light, and the electrode are in the same place.",
    body: [
  ...
  },
  {
    ...
    lede: "No nanoparticle method has ever been able to choose between an excitatory and an inhibitory neuron. That is what still makes them blunt instruments.",
    body: [
  ...
  },
  {
    ...
    lede: "Every established way to address a memory engram begins by putting a gene into it.",
    body: [
  ...
  },
  {
    ...
    lede: "Engram work has shown that a memory can be reactivated, and even installed. Both require knowing which neurons to touch — and that cannot be known in advance.",
    body: [
